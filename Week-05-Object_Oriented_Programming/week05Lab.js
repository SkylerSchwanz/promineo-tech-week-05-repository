...
console.log(
  `On July 20th ${person.year}, ${person.lastname} ${person.lastname} was the first person to set foot on the Earth's moon.`
);
/*-------------------------------------------------------*/
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting("Skyler", "NV");
myGreeting.hello();
...
class List {
  ...
  displayMovies() {
    this.movies.forEach((element) => console.log(element));
  }
}
